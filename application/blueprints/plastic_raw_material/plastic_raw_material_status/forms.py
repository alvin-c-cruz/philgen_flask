...
from .models import PlasticRawMaterialStatus as Obj
from .models import UserPlasticRawMaterialStatus as Preparer
from .models import AdminPlasticRawMaterialStatus as Approver
...
class Form:
    id: int = None
    plastic_raw_material_status_name: str = ""
    ...
    def _validate_on_submit(self):
        ...
        if not self.plastic_raw_material_status_name:
            self.errors["plastic_raw_material_status_name"] = "Please type description."
