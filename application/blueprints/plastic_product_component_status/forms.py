...
from .models import PlasticProductComponentStatus as Obj
from .models import UserPlasticProductComponentStatus as Preparer
from .models import AdminPlasticProductComponentStatus as Approver
...
class Form:
    id: int = None
    plastic_product_component_status_name: str = ""
    ...
    def _validate_on_submit(self):
        ...
        if not self.plastic_product_component_status_name:
            self.errors["plastic_product_component_status_name"] = "Please type description."
