...
from .models import PlasticLabelStatus as Obj
from .models import UserPlasticLabelStatus as Preparer
from .models import AdminPlasticLabelStatus as Approver
...
class Form:
    ...
    def _validate_on_submit(self):
        ...
        if not self.plastic_label_status_name:
            self.errors["plastic_label_status_name"] = "Please type description."
