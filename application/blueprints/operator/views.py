...
def unlock(record_id):
    ...
    approve = Approver.query.filter_by(operator_id=record_id).first()
...
@login_required
def _autocomplete():
    options = [i for i in Obj.query.order_by(Obj.last_name, Obj.first_name, Obj.middle_name).all()]
